...
type MessageStore interface {
	...
	GetMessage(ctx context.Context, mailboxID int64, uid uint32) (*domain.Message, []byte, error)
	UpdateFlags(ctx context.Context, mailboxID int64, uid uint32, add, remove []string) error
	MoveMessage(ctx context.Context, mailboxID int64, uid uint32, toFolder string) error
